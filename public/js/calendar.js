...
/* harmony import */ var _fullcalendar_core_locales_ja__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fullcalendar/core/locales/ja */ "./node_modules/@fullcalendar/core/locales/ja.js");
/* harmony import */ var _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fullcalendar/daygrid */ "./node_modules/@fullcalendar/daygrid/main.js");
...
// fullカレンダーのバッケージを読み込む




 // DOMを読み込む　　　　　　　　　　　　　　　<div id="calendar"

var calendarEl = document.getElementById("calendar"); // 　　　　　　　　インスタンス化　要素として渡す

var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.Calendar(calendarEl, // 下記はカレンダーの設定
{
  ...
  // 日本語化
  locales: _fullcalendar_core_locales_ja__WEBPACK_IMPORTED_MODULE_1__["default"],
  // 実際に使うのを選ぶ
  locale: 'ja',
  // 日付表示の境界線時刻を設定(デフォルトは9時)
  // 深夜２時なら前日深夜２時と書いたほうが親切な時は書き換え
  nextDayThreshold: '00:00:00',
  // データを用意
  // web.phpに記載　Route::get('calendar/action', [FullCalendarController::class, 'index']);
  events: '/calendar/action',
  // 予定がない部分をクリック
  selectable: true,
  // trueにしないと選択できない
  select: function select(start, end, allDay) {
    // alert('予定がないselectのイベントです');
  ...
  eventClick: function eventClick(event) {
    alert('予定があるeventClickのイベントです');
  },
  // 予定をドラッグ&ドロップ
  eventDrop: function eventDrop(event, delta) {
    alert('ドラッグ＆ドロップeventDropのイベントです');
  },
  // 予定時刻のサイズ変更
  editable: true,
  // trueにしないと変更できない
  eventResize: function eventResize(event, delta) {
...
calendar.render(); // キャンセルボタンの処理

var closeModalButton = document.getElementById('cancel-button');
